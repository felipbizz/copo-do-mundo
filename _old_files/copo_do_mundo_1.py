...
with col1:
    Caipirinha_1 = st.number_input("Vote para Caipirinha_1 :", 0, 10, 0, key="Caipirinha_1")
    Caipirinha_2 = st.number_input("Vote para Caipirinha_2 :", 0, 10, 0, key="Caipirinha_2")
    Caipirinha_3 = st.number_input("Vote para Caipirinha_3 :", 0, 10, 0, key="Caipirinha_3")
    Caipirinha_4 = st.number_input("Vote para Caipirinha_4 :", 0, 10, 0, key="Caipirinha_4")

with col2:
    Livre_1 = st.number_input("Vote para Livre_1 :", 0, 10, 0, key="Livre_1")
    Livre_2 = st.number_input("Vote para Livre_2 :", 0, 10, 0, key="Livre_2")
    Livre_3 = st.number_input("Vote para Livre_3 :", 0, 10, 0, key="Livre_3")
    Livre_4 = st.number_input("Vote para Livre_4 :", 0, 10, 0, key="Livre_4")

with col3:
    LeiteCond_1 = st.number_input("Vote para LeiteCond_1 :", 0, 10, 0, key="LeiteCond_1")
    LeiteCond_2 = st.number_input("Vote para LeiteCond_2 :", 0, 10, 0, key="LeiteCond_2")
    LeiteCond_3 = st.number_input("Vote para LeiteCond_3 :", 0, 10, 0, key="LeiteCond_3")
    LeiteCond_4 = st.number_input("Vote para LeiteCond_4 :", 0, 10, 0, key="LeiteCond_4")
